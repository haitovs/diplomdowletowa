          ...
          <div>
              ...
              <table className="w-full text-sm">
                <tbody>
                  <tr className="border-b border-gray-100">
                    <td className="py-3 px-4 font-semibold text-gray-500 bg-gray-50 w-1/3">Type</td>
                    <td className="py-3 px-4 text-gray-800">{product.category.name}</td>
                  </tr>
                  <tr className="border-b border-gray-100">
                    <td className="py-3 px-4 font-semibold text-gray-500 bg-gray-50">Fiber</td>
                    <td className="py-3 px-4 text-gray-800">{product.fiber}</td>
                  </tr>
                  <tr className="border-b border-gray-100">
                    <td className="py-3 px-4 font-semibold text-gray-500 bg-gray-50">Technique</td>
                    <td className="py-3 px-4 text-gray-800">{product.technique}</td>
                  </tr>
                  {product.dimensions && (
                    <tr className="border-b border-gray-100">
                      <td className="py-3 px-4 font-semibold text-gray-500 bg-gray-50">Dimensions</td>
                      <td className="py-3 px-4 text-gray-800">{product.dimensions}</td>
                    </tr>
                  )}
                  <tr>
                    <td className="py-3 px-4 font-semibold text-gray-500 bg-gray-50">Availability</td>
            ...
            {product.delivery && (
              <div className="mt-6 flex items-start gap-3 p-4 bg-turkmen-green/5 rounded-lg text-sm text-turkmen-green">
                ...
                <div>
                  <span className="font-bold block mb-1">Shipping Information</span>
                  {product.delivery}
                </div>
              </div>
            )}
